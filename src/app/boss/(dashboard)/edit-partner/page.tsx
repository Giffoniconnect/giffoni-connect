    ...
    return (
        <div className="flex flex-col gap-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-bold tracking-tight">
                        Editor do Portal do Parceiro
                    </h1>
                    <p className="text-muted-foreground">
                        Gerencie os dados cadastrais e funcionalidades relacionadas aos parceiros.
                    </p>
                </div>
            </div>
            <div className="grid grid-cols-1 xl:grid-cols-2 gap-6 items-start">
                <Card>
                    <CardHeader>
                        <CardTitle>Dados Cadastrais dos Parceiros</CardTitle>
                    </CardHeader>
                    <CardContent className="flex flex-col sm:flex-row gap-4">
                        <Link href="/boss/partners">
                            <Button>
                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow>
                                        ...
                                        <TableHead>Parceiro Responsável</TableHead>
