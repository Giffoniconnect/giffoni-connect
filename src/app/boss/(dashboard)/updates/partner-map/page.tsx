...
export default function PartnerMapPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">
            Mapa de Updates do Painel do Parceiro
          </h1>
          <p className="text-muted-foreground">
            Estrutura de funcionalidades do portal de parceiros.
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Mapa Vivo do Portal do Parceiro</CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-4">
          <Accordion
            ...
            collapsible
            className="w-full"
            defaultValue={mockPartnerPortalTree[0]?.id_tela}
          >
            {mockPartnerPortalTree.map((screen) => (
