...
export default function ClientMapPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">
            Mapa de Updates do Painel do Cliente
          </h1>
          <p className="text-muted-foreground">
            Estrutura de funcionalidades do portal principal do cliente.
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Mapa Vivo do Portal do Cliente</CardTitle>
          <CardDescription>
            Clique em cada tela para expandir e navegar por suas seções e
            funcionalidades, refletindo a estrutura da sidebar do cliente.
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          <Accordion
            ...
            collapsible
            className="w-full"
            defaultValue={mockClientPortalTree[0]?.id_tela}
          >
            {mockClientPortalTree.map((screen) => (
