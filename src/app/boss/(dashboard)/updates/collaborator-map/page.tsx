...
export default function CollaboratorMapPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">
            Mapa de Updates do Painel do Colaborador
          </h1>
          <p className="text-muted-foreground">
            Estrutura de funcionalidades da área de trabalho da equipe.
          </p>
        </div>
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Mapa Vivo do Portal do Colaborador</CardTitle>
          <CardDescription>
        ...
        <CardContent className="space-y-4">
          <Accordion
            ...
            collapsible
            className="w-full"
            defaultValue={mockCollaboratorPortalTree[0]?.id_tela}
          >
            {mockCollaboratorPortalTree.map((screen) => (
